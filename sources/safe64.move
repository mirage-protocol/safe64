...
module safe64::safe64 {
    ...
    /// Multiply
    public inline fun mul(x: u64, y: u64): u128 {
        (x as u128) * (y as u128)
    }

    /// Multiply and divide
    public inline fun muldiv(x: u64, y: u64, z: u64): u128 {
    ...
    public inline fun mul3(x: u64, y: u64, z: u64): u256 {
        (x as u256) * (y as u256) * (z as u256)
    }

    /// Multiply 3 and divide
    public inline fun mul3div(a: u64, b: u64, c: u64, d: u64): u256 {
    ...
    /// Multiply 3, divide 2
    public inline fun mul3div2(a: u64, b: u64, c: u64, d: u64, e: u64): u256 {
    ...
    /// Multiply 3, divide 3
    public inline fun mul3div3(a: u64, b: u64, c: u64, d: u64, e: u64, f: u64): u256 {
    ...
    /// Square a number
    public inline fun square(x: u64): u128 {
        (x as u128) * (x as u128)
    }
}
